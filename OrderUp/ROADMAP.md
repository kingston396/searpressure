...
- Economy: per-level coin budgets (10% on completed replays), doubled prices, permanent forked upgrades, and a 400-coin daily quest. Every service varies: mirrored layouts, shuffled crates, random events and new driving cities.
