...
- Bonus boss: The Judge's Table (strikes, cold/overcooked checks, parody judges Nyesha Garnishton, Richard Braise and Yourdone Ramsey).
...
- Economy: per-level coin budgets (20% on completed replays; random events only on three-starred replays), doubled prices, permanent forked upgrades, and a 400-coin daily quest. Every service varies: mirrored layouts, shuffled crates, random events and new driving cities.
